      ...
      <div className="font-sans mx-auto min-h-screen max-w-screen-xl px-6 py-12 md:px-12 md:py-20 lg:px-24 lg:py-0">
        <div>
          ...
          {isMobile && (
            <button
              onClick={scrollToTop}
              className="fixed bottom-4 right-4 p-3 bg-teal-300 text-white rounded-full shadow-lg transition-colors duration-300 hover:bg-teal-400 z-50"
              style={{ zIndex: 9999 }}
            >
        ...
        <div className="lg:flex lg:justify-between lg:gap-4">
          <header className="mr-1 lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 overflow-y-hidden border-none border-2 border-red-600">
            <div>
              ...
              <div className="relative mt-3">
                <h2 className="mb-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl">
                  Full Stack{" "}
                  <span className="bg-teal-300 text-slate-800 font-semibold">
                    .Net Developer
                  </span>
                </h2>
              </div>
              ...
              <ul className="mt-5 flex items-center" aria-label="Social media">
                {socialMediaLinks.map(({ href, label, imgSrc }) => (
                  <li className="mr-5 text-xs" key={label}>
                    ...
                    >
                      ...
                      <img className="h-8 w-8" alt={label} src={imgSrc} />
                    </a>
                  </li>
                ))}
              </ul>
              <p className="mt-8 my-3 font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300">
                <a
          ...
          <div className="pt-24 lg:w-1/2 lg:py-24 border-none border-2 border-indigo-600">
            <main>
              <div>
                <section
                  id="about"
                ...
                <div className="my-2 border-t border-gray-600 w-full" />
                <section
                  id="skills"
                  aria-label="skills"
                  className="mb-16 scroll-mt-16 md:mb-24 lg:mb-16 lg:scroll-mt-24"
                ...
                >
                  ...
                  {skills.length > skillVisibleCount && (
                    <button
                      ...
                      className="mt-4 rounded bg-teal-500 px-4 py-2 text-sm text-white"
                    >
                      {isExpanded ? "Show Less" : "Show All"}
                    </button>
                  )}
                </section>{" "}
                <div className="my-4 border-t border-gray-600 w-full" />
                <section
                  id="experience"
                      ...
                      (experience: Experience, index: number) => (
                        <li key={index} className="mb-12">
                          <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-[1rem] transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-slate-800/50 lg:group-hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:group-hover:drop-shadow-lg"></div>
                            <header
                ...
                >
                  <div className="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-slate-900/75 px-6 py-3 backdrop-blur md:-mx-12 md:px-12 lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0">
                    <h2 className="text-base font-semibold uppercase tracking-widest text-slate-200">
                      ...
                      {certifications.map((certification, index) => (
                        <li key={index} className="mb-1">
                          <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-[1rem] transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-slate-800/50 lg:group-hover:shadow-lg lg:group-hover:opacity-90"></div>
                            <div className="z-10 sm:order-2 sm:col-span-6">
                              ...
                              <p className="mt-1 text-sm leading-normal text-slate-400 whitespace-nowrap">
